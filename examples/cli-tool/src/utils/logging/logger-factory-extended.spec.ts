...
describe('setMinLevel', () => {
  ...
  it('should update level dynamically', () => {
    ...
    expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('should appear'))
  })
})
...
describe('setDebugMode() console threshold update', () => {
  it('should update console minimum level when debug mode changes', () => {
    ...
    expect(consoleSpy.log).toHaveBeenCalledWith(expect.stringContaining('debug message 2'))
  ...
  it('should handle complex enable/disable sequences', () => {
    ...
    expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('debug after sequence'))
